"""
Alembic env.py — Sahayak AI
=============================
Configures async migrations using the application's settings.
...
# ── CRITICAL: import every model so Alembic sees all tables ──────────────
import app.models  # noqa: F401  — triggers app/models/__init__.py

# Alembic Config object
config = context.config

# Inject real DATABASE_URL (overrides alembic.ini placeholder)
