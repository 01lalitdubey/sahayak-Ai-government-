...
try:
    ...
    from ranker import UserProfile as RankerUserProfile
except ImportError:
    try:
        from app.services.recommender import recommend_schemes  # type: ignore[no-redef]
        from app.services.ranker import UserProfile as RankerUserProfile  # type: ignore[no-redef]
    except ImportError:
